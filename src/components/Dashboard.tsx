...
function Dashboard() {
  ...
  }, [user, navigate, fetchStakes, fetchReferralStats, generateReferralCode]);
          ...
          <div className="bg-slate-800/50 backdrop-blur-xl rounded-xl p-6 border border-slate-700/50 hover:border-green-500/50 transition-colors">
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-400">{totalRewards.toFixed(4)} ETH</p>
                <p className="text-sm text-green-500">≈ ${(totalRewards * ethPrice).toLocaleString()}</p>
              </div>
          ...
          <div className="bg-slate-800/50 backdrop-blur-xl rounded-xl p-6 border border-slate-700/50 hover:border-blue-500/50 transition-colors">
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-blue-400">{dailyRewards.toFixed(4)} ETH</p>
                <p className="text-sm text-blue-500">≈ ${(dailyRewards * ethPrice).toLocaleString()}</p>
              </div>
              <div className="bg-blue-500/20 p-2 rounded-lg">
